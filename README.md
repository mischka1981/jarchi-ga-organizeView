...
I asked ChatGPT to make it better, and the output had very many missing edges, many missing nodes, some spelling mistakes. The following image was generated by the OpenAI’s GPT-5 model. The prompt was "can you please improve the layout of my archimate view?" and when it asked back what to focus on, I replied: "data flow please; generate new improved image".
![Markdown Logo](view1chatgpt.png)

So as of today, LLM are not fit for that task. How would they, given that here we deal with boxes, not words. 
